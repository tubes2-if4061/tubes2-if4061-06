...
COMPARE_YEAR_SLIDER_IDS = [
    "compare-year-1-slider",
    "compare-year-2-slider",
...
COMPARE_YEAR_SLIDER_ROW_IDS = [
    ...
    "compare-year-3-slider-row",
    "compare-year-4-slider-row",
]
